...
public class SmartScriptParser {
	...
	static private enum ParserState {
		...
		/**
		 * prvi argument for taga
		 */
		FOR_TAG_1,
		
		/**
		 * drugi argument for taga
		 */
		FOR_TAG_2,
		
		/**
		 * treci argument for taga
		 */
		FOR_TAG_3,
		
		/**
		 * cetvrti element for taga
		 */
		FOR_TAG_4,
	...
	static private enum TokenType {
		/**
		 * nalazimo se u double vrijednosti
		 */
		DOUBLE,
		
		/**
		 * nalazimo se u integer vrijednosti
		 */
		INTEGER,
		
		/**
		 * nalazimo se u funkciji
		 */
		FUNCTION,
		
		/**
		 * nalazimo se u stringu
		 */
		STRING,
		
		/**
		 * nalazimo se u obicnom tekstu
		 */
		TEXT,
		
		/**
		 * nalazimo se u varijabli
		 */
		VARIABLE,
		
		/**
		 * nalazimo se izmedu nekih tokena
		 */
		BLANK
	}
	/**
	 ...
	 * @param docBody String koji sadrzi sadrzaj dokumenta
	 */ 
	 ...
	 */
	private DocumentNode parse(ArrayBackedIndexedCollection tokens) {
	 ...
	 */
	private ArrayBackedIndexedCollection tokenize(String document) {
		int insideTag = 0;
