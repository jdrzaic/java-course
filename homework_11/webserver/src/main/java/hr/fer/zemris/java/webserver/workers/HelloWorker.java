 ...
 * Implementacija klijentu vraca html dokument 
 * s porukom hello i informacijom o broju slova vrijednosti pridruzenoj parametru
 * 'name', ili poruku ako takav ne postoji.
 * @author jelena
 *
 */
